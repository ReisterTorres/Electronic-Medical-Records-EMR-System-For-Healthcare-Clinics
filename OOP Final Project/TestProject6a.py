...
def login():
    ...
    global frame2
    frame2 = customtkinter.CTkFrame(app, bg_color='#87cfeb', fg_color='#87cfeb', width=470, height=360)
    frame2.place(x=0, y=0)

    login_label2 = customtkinter.CTkLabel(frame2, font=font1, text='Log In', text_color='#000000', bg_color='#87cfeb')
    ...
    username_entry2 = customtkinter.CTkEntry(frame2, font=font2, text_color='#000000', fg_color='#ffffff', bg_color='#87cfeb', border_color='#000000', border_width=1, placeholder_text='Username', placeholder_text_color='#3e4d4f', width=200, height=50)
    username_entry2.place(x=(470-200)/2, y=120)

    password_entry2 = customtkinter.CTkEntry(frame2, font=font2, show='*', text_color='#000000', fg_color='#ffffff', bg_color='#6dceed', border_color='#000000', border_width=1, placeholder_text='Password', placeholder_text_color='#3e4d4f', width=200, height=50)
...
frame1 = customtkinter.CTkFrame(app, bg_color='#87cfeb', fg_color='#87cfeb', width=470, height=360)
frame1.place(x=0, y=0)

signup_label = customtkinter.CTkLabel(frame1, font=font1, text='Sign up', text_color='#000000', bg_color='#87cfeb')
signup_label.place(x=200, y=20)

username_entry = customtkinter.CTkEntry(frame1, font=font2, text_color='#000000', fg_color='#ffffff', bg_color='#000000', border_color='#000000', border_width=1, placeholder_text='Username', placeholder_text_color='#3e4d4f', width=200, height=50)
username_entry.place(x=135, y=90)

password_entry = customtkinter.CTkEntry(frame1, font=font2, show='*', text_color='#000000', fg_color='#ffffff', bg_color='#000000', border_color='#000000', border_width=1, placeholder_text='Password', placeholder_text_color='#3e4d4f', width=200, height=50)
password_entry.place(x=135, y=160)
